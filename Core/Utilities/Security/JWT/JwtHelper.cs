...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public JwtSecurityToken CreateJwtSecurityToken(TokenOptions tokenOptions, Users user, SigningCredentials signingCredentials, List<OperationClaim> operationClaims)
        {
